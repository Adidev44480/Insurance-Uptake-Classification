...
The best performance was achieved with the Logistic Regression with 87% recall, 79% accuracy and 0.70 AUC-ROC. I chose Logistic Regression for the _best recall_ and simpler explanation and stable calibration. The model is significantly helpful in identifying potential buyers, reducing marketing cost and improving conversion rates.
